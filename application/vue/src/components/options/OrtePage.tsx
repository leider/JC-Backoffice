...
function OrtePageInternal() {
  const columnDescriptions: JazzColumn[] = [
    { dataIndex: "name", title: "Name", type: "text", width: "200px", required: true, uniqueValues: true },
    { dataIndex: "flaeche", title: "Fläche", type: "integer", width: "100px", required: true },
    { dataIndex: "pressename", title: "Für Presse", type: "text", width: "200px", required: true },
    { dataIndex: "presseIn", title: 'Für Presse mit "in"', type: "text", width: "300px", required: true },
  ];
