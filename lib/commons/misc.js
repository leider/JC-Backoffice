...
module.exports = {
  ...
  vorigerOderAktuellerUngeraderMonat: function vorigerOderAktuellerUngeraderMonat(aMoment) {
    return aMoment.clone().subtract(1 + (aMoment.month() % 2 ? 0 : -1), 'months');
  },

  naechsterUngeraderMonat: function naechsterUngeraderMonat(aMoment) {
    return aMoment.clone().add(1 + (aMoment.month() % 2 ? 0 : 1), 'months');
  }
