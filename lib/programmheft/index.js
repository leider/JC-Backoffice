...
app.get('/kalenderFor', (req, res, next) => {
  ...
  const addend = from.monat() % 2 === 1 ? 1 : 2; // wir wollen die 2 Monate vor dem Programmheft, gespeichert ist es aber zum Heftstart
    ...
    veranstaltungenstore.byDateRangeInAscendingOrder(
      ...
      (err1, veranstaltungen) => {
        ...
        const groupedVeranstaltungen = R.groupBy(
          veranst => veranst.startMoment().format("MMMM 'YY"),
