...
module.exports = {
  ...
  getCurrentKalender: function getCurrentKalender(aDatumUhrzeit, callback) {
    this.getKalender(aDatumUhrzeit.vorigerOderAktuellerUngeraderMonat().format('YYYY/MM'), callback);
  },

  getNextKalender: function getNextKalender(aDatumUhrzeit, callback) {
    this.getKalender(aDatumUhrzeit.naechsterUngeraderMonat().format('YYYY/MM'), callback);
  }
};
