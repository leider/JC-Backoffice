...
app.get('/:url/deutsch', (req, res, next) => {
  renderVertrag('deutsch', true, req, res, next);
});

app.get('/:url/regional', (req, res, next) => {
  renderVertrag('deutsch', false, req, res, next);
});

app.get('/:url/englisch', (req, res, next) => {
  renderVertrag('englisch', true, req, res, next);
});
