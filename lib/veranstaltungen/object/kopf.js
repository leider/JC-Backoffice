...
class Kopf {
  ...
  fillFromUI(object) {
    ['beschreibung', 'eventTyp', 'flaeche', 'kooperation', 'ort', 'titel',
      'verantwortlicher', 'pressename', 'presseIn', 'genre'].forEach(field => {
  ...
  rechnungAnKooperation() {
    return this.state.rechnungAnKooperation === undefined ? this.isKooperation() : this.state.rechnungAnKooperation;
  }
