...
class Werbung {
  ...
  fillFromUI(object) {
    ...
    ['plakat1KW', 'plakat2KW', 'plakat1Groesse', 'plakat2Groesse', 'flyerInfo', 'layoutingInfo', 'genehmigungenInfo', 'plakat1Von', 'plakat2Von', 'genehmigt'].forEach(field => {
  ...
  genehmigungErfolgt(jaNein) {
    this.state.genehmigt = jaNein;
  }
  ...
  layoutingEUR(optionen) {
    return this.state.layoutingEUR || (optionen ? optionen.layoutingEUR() : 0);
  }
