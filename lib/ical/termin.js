...
class Termin {
  ...
  fillFromUI(object) {
    this.state.startDate = DatumUhrzeit.forGermanString(object.startDate).toJSDate();
    this.state.endDate = DatumUhrzeit.forGermanString(object.endDate, '12:00').toJSDate();
