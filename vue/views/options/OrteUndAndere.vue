                ...
                table.table.table-sm.table-striped
                  tbody
                    tr
                      ...
                      th
                    ort-row(
                      v-for="(ort, index) in orte.orte",
                      :key="index",
                      :ort="ort",
                      @loeschen="deleteOrt(ort)",
                      @speichern="saveOrt()"
                    )
</template>
...
export default class OrteUndAndere extends Vue {
  @Prop() tab!: string;
  ...
  mounted(): void {
    ...
    optionen((optionen: OptionValues) => {
  ...
  saveOrt(): void {
    saveOrte(this.orte, (result: any) => {
      console.log(result);
    });
  }

  saveOptionen(): void {
    saveOptionen(this.optionen, () => {
